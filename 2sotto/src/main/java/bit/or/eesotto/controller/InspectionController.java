...
public class InspectionController {
	...
	@Autowired
	private MedicalService InspectionService;
	
	

	// 병원이용 홈 보여주기
	@RequestMapping(value = "getInspectionList.bit", method = RequestMethod.GET) 
	public String getMrecordList(String cp, String ps, Principal principal, Model model) {
		...
		HashMap<String, Object> map = InspectionService.getMrecordList(cp, ps, userid);		
