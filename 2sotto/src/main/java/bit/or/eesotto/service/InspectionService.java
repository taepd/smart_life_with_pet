...
import bit.or.eesotto.dao.InspectionDao;
...
import bit.or.eesotto.dto.Inspection;
...
public class InspectionService {
	...
	//병원이용 기록 등록하기
	public int InspectionRegister(Inspection inspection) {
		
		int result = 0;
		
		try {
			inspectionDao = sqlsession.getMapper(InspectionDao.class);
			result = inspectionDao.inspectionRegister(inspection);
		} catch (Exception e) {
