...
<nav class="navbar navbar-default fixed-top" role="navigation-demo">
	<a class="toggle-btn"><span class="toggle-btn"><i
			class="fas fa-bars"></i></span></a> <span id="header-title"><a
		href="${pageContext.request.contextPath}/index.jsp">슬기로운 반려생활</a></span>
	<ul class="navbar-nav ml-auto">
		<c:choose>
			<c:when test="${userid == null}">
				<li class="nav-item" id="item01"><a
					href="${pageContext.request.contextPath}/login.bit"
					class="nav-link">로그인</a></li>
				<li class="nav-item" id="item02"><a
					href="${pageContext.request.contextPath}/register.bit"
					class="btn btn-rose btn-raised btn-round"> 시작하기 </a></li>
			</c:when>
			<c:otherwise>
				<li class="nav-item" id="item01"><a
					href="${pageContext.request.contextPath}/login.bit"
				...
				<li class="nav-item" id="item02"><a
					href="${pageContext.request.contextPath}/logout.bit"
					class="btn btn-rose btn-raised btn-round"> 로그아웃 </a></li>
			</c:otherwise>
		</c:choose>
	</ul>
</nav>
