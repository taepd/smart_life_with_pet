	...
	<div class="side_overlay">
		...
		<div class="row">
				...
				<div class="col-8 area">
					...
					<div class="card card-nav-tabs">				
					<div class="card-body">
					<a href="adminDonationdetail.bit?dindex=${donate.dindex}" style="color: #EE82EE;"><span id="back-icon"><i class="fas fa-angle-double-left"></i></span></a>
					<br>
					<div class="col-12 title-area">
					<h3 style=" text-align: center">후원글 수정페이지<i class="fas fa-paw"></i></h3>
					</div>
					<br>
					<form id="joinForm" action="adminDonationupdate.bit" method="post" enctype="multipart/form-data">
					<div id="joinForm-wrapper">
								...
								<div class="card-body" style="text-align: center;">
									<button type="submit" class="btn btn-primary"><b>글 수정 완료</b></button>
									<button type="reset" class="btn btn-outline-primary" onclick="location.href='adminDonationdetail.bit?dindex=${donate.dindex}'">글 수정 취소</button>
								</div>								
							<br>						
						</div>
					</form>
