		...
		<div class="side_overlay">
			<div class="main-card">
				...
				<li class="nav-item dropdown" style="float: right;">
					...
					<c:if test="${sessionScope.user.userid eq qna.userid}">
						<div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
			            	<a class="dropdown-item" href="edit.bit?qaindex=${qna.qaindex}">수정</a>
			            	<a class="dropdown-item" href="reply.bit?qaindex=${qna.qaindex}">관리자 답글</a>
