...
CREATE TABLE DONATIONLIST (
	DLINDEX  INT  PRIMARY KEY AUTO_INCREMENT, -- 기부글번호
...
CREATE TABLE DONATION (
	DINDEX INT          PRIMARY KEY AUTO_INCREMENT, -- 기부번호
	DLINDEX  INT          NOT NULL, -- 기부글번호
...
ALTER TABLE PAY
	ADD
		CONSTRAINT FK_DONATIONLIST_TO_PAY -- 기부게시판 -> 결제(돈내고 한 것만)
		FOREIGN KEY (
			DLINDEX -- 기부글번호
		)
		REFERENCES DONATIONLIST ( -- 기부게시판
			DLINDEX -- 기부글번호
		)
		ON DELETE CASCADE;
...
ALTER TABLE DONATIONCOMMENT
	ADD
		CONSTRAINT FK_DONATIONLIST_TO_DONATIONCOMMENT -- 
		FOREIGN KEY (
			DLINDEX -- 글번호
		)
		REFERENCES DONATIONLIST ( -- 게시글
			DLINDEX -- 글번호
		)
		ON DELETE CASCADE;
...
ALTER TABLE DONATION
	ADD
		CONSTRAINT FK_USER_TO_DONATION -- 
		FOREIGN KEY (
			USERID -- 기부자
		)
		REFERENCES USER ( -- 게시글
...
-- 기부내역 DONATIONLIST에서 DLINDEX
ALTER TABLE DONATION
	ADD
		CONSTRAINT FK_DONATIONLIST_TO_DONATION -- 
		FOREIGN KEY (
			DLINDEX -- 기부자
		)
		REFERENCES DONATIONLIST ( -- 게시글
